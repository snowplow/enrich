...
import com.snowplowanalytics.snowplow.enrich.pubsub.config.{CliConfig, ConfigFile}
import com.snowplowanalytics.snowplow.enrich.pubsub.config.io.{Output => OutputConfig}
import com.snowplowanalytics.snowplow.enrich.pubsub.io.{Clients, FileSystem, Metrics, Sinks, Source}
...
object Environment {
  ...
  private[pubsub] final case class ParsedConfigs(
    igluJson: Json,
  ...
  private[pubsub] def outputAttributes(output: OutputConfig): EnrichedEvent => Map[String, String] =
    output match {
