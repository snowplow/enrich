...
object Containers {
  object Images {
    ...
    val Enrich = DockerImage("snowplow/snowplow-enrich-nsq", s"${BuildInfo.version}-next-distroless")
  }
  ...
  private def enrich(
    ...
    for {
      ...
      configPath = "modules/common-streams/nsq/src/it/resources/enrich-nsq.hocon"
