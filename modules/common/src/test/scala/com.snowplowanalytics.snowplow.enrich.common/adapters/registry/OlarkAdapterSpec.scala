...
class OlarkAdapterSpec extends Specification with DataTables with ValidatedMatchers {
  ...
  object Shared {
    val api = CollectorPayload.Api("com.olark", "v1")
  ...
  def e1 = {
    ...
    OlarkAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beValid(expected)
  }
  ...
  def e3 = {
    ...
    OlarkAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beInvalid(
      NonEmptyList.one(
  ...
  def e6 = {
    ...
    OlarkAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beInvalid(expected)
  }
  ...
  def e8 = {
    ...
    OlarkAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beInvalid.like {
      case nel =>
        nel.size must_== 1
