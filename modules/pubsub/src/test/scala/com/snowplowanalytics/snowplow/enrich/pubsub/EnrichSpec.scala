...
import com.snowplowanalytics.snowplow.enrich.pubsub.EnrichSpec.{Expected, minimalEvent, normalizeResult}
...
object EnrichSpec {
  ...
  val minimalEvent = Event
    .minimal(
      ...
      "ssc-0.0.0-test",
      s"snowplow-enrich-pubsub-${generated.BuildInfo.version}-common-${generated.BuildInfo.version}"
    )
