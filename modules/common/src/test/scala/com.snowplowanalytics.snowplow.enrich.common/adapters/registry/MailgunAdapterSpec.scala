...
class MailgunAdapterSpec extends Specification with DataTables with ValidatedMatchers {
  ...
  def e1 = {
    ...
    MailgunAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beValid(expected)
  }
  ...
  def e6 = {
    ...
    MailgunAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beInvalid(
      NonEmptyList.one(
  ...
  def e9 = {
    ...
    MailgunAdapter.toRawEvents(payload, SpecHelpers.client, SpecHelpers.blocker) must beInvalid(expected)
  }
