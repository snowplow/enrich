...
import com.snowplowanalytics.snowplow.enrich.pubsub.{Payload, RawSource}
import com.snowplowanalytics.snowplow.enrich.pubsub.config.io.{Authentication, Input}
