/*
 * Copyright (c) 2013-2020 Snowplow Analytics Ltd.
 * All rights reserved.
 *
...
class EnrichedEventSpec extends Specification {
  ...
  "toPartiallyEnrichedEvents" should {
    ...
    "Convert defined fields to None" in {
      ...
      testField(_.txn_id = "txn_id", _.txn_id)
      ...
      testField(_.domain_sessionidx = new JInteger(0), _.domain_sessionidx)
      ...
      testField(_.geo_latitude = new JFloat(0.0), _.geo_latitude)
      testField(_.geo_longitude = new JFloat(0.0), _.geo_longitude)
      ...
      testField(_.page_urlport = new JInteger(0), _.page_urlport)
      ...
      testField(_.refr_urlport = new JInteger(0), _.refr_urlport)
      ...
      testField(_.se_value = "se_value", _.se_value)
      ...
      testField(_.tr_total = "tr_total", _.tr_total)
      testField(_.tr_tax = "tr_tax", _.tr_tax)
      testField(_.tr_shipping = "tr_shipping", _.tr_shipping)
      ...
      testField(_.ti_price = "ti_price", _.ti_price)
      testField(_.ti_quantity = new JInteger(0), _.ti_quantity)
      testField(_.pp_xoffset_min = new JInteger(0), _.pp_xoffset_min)
      testField(_.pp_xoffset_max = new JInteger(0), _.pp_xoffset_max)
      testField(_.pp_yoffset_min = new JInteger(0), _.pp_yoffset_min)
      testField(_.pp_yoffset_max = new JInteger(0), _.pp_yoffset_max)
      ...
      testField(_.br_features_pdf = new JByte(Byte.MinValue), _.br_features_pdf)
      testField(_.br_features_flash = new JByte(Byte.MinValue), _.br_features_flash)
      testField(_.br_features_java = new JByte(Byte.MinValue), _.br_features_java)
      testField(_.br_features_director = new JByte(Byte.MinValue), _.br_features_director)
      testField(_.br_features_quicktime = new JByte(Byte.MinValue), _.br_features_quicktime)
      testField(_.br_features_realplayer = new JByte(Byte.MinValue), _.br_features_realplayer)
      testField(_.br_features_windowsmedia = new JByte(Byte.MinValue), _.br_features_windowsmedia)
      testField(_.br_features_gears = new JByte(Byte.MinValue), _.br_features_gears)
      testField(_.br_features_silverlight = new JByte(Byte.MinValue), _.br_features_silverlight)
      testField(_.br_cookies = new JByte(Byte.MinValue), _.br_cookies)
      testField(_.br_colordepth = "br_colordepth", _.br_colordepth)
      testField(_.br_viewwidth = new JInteger(0), _.br_viewwidth)
      testField(_.br_viewheight = new JInteger(0), _.br_viewheight)
      ...
      testField(_.dvce_ismobile = new JByte(Byte.MinValue), _.dvce_ismobile)
      testField(_.dvce_screenwidth = new JInteger(0), _.dvce_screenwidth)
      testField(_.dvce_screenheight = new JInteger(0), _.dvce_screenheight)
      testField(_.doc_charset = "doc_charset", _.doc_charset)
      testField(_.doc_width = new JInteger(0), _.doc_width)
      testField(_.doc_height = new JInteger(0), _.doc_height)
      testField(_.tr_currency = "tr_currency", _.tr_currency)
      testField(_.tr_total_base = "tr_total_base", _.tr_total_base)
      testField(_.tr_tax_base = "tr_tax_base", _.tr_tax_base)
      testField(_.tr_shipping_base = "tr_shipping_base", _.tr_shipping_base)
      testField(_.ti_currency = "ti_currency", _.ti_currency)
      testField(_.ti_price_base = "ti_price_base", _.ti_price_base)
