...
object Dependencies {
  ...
  object Libraries {
    ...
    val eventGen = "com.snowplowanalytics"        %% "snowplow-event-generator-core"         % V.eventGen
    val eventFile = "com.snowplowanalytics"       %% "snowplow-event-generator-file-sink"    % V.eventGen
